...
<dict>
	...
	<array>
		<dict>
			...
			<dict>
				<key>default</key>
				<string>圖片減肥（PNG_JPG_WEBP）</string>
			</dict>
			<key>NSMessage</key>
...
cat > "$TARGET/Contents/version.plist" <<'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
  <key>workflow.automator.version</key>
  <string>2.10</string>
</dict>
</plist>
EOF
...
if ! command -v pngquant &gt;/dev/null 2&gt;&amp;1 || ! command -v jpegoptim &gt;/dev/null 2&gt;&amp;1 || ! command -v cwebp &gt;/dev/null 2&gt;&amp;1; then
  echo "找不到壓縮工具，請重新執行安裝腳本。" &gt;&amp;amp;2
  exit 1
fi
  ...
  case "$ext" in
    ...
    webp)
      ...
      ;;
        ...
        <key>InputUUID</key>
        <string>27B12EF0-63B8-4B57-ADE9-E1E65B47454A</string>
        <key>Keywords</key>
        <array>
          <string>Shell</string>
          <string>工序指令</string>
        ...
        <key>OutputUUID</key>
        <string>AF3B813A-1326-455E-ACC0-A28D79789A0F</string>
        <key>UUID</key>
        <string>E2D45912-671C-428C-85E2-C40C62966A0B</string>
